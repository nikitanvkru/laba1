...
HD_PWD='C:/Users/8171268/Desktop/lab1/tmp/lab1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hex_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hex_test.tcl -notrace
